  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const data = Array.isArray(banksData) ? banksData : []
        setBanks(data)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">South African Banks</h1>
          ...
          <Card key={index} className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">{bank.name || bank.bank_name || `Bank ${index + 1}`}</CardTitle>
                  {bank.code && (
