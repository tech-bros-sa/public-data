...
import { Download, Database, MapPin, Building2, Landmark, GraduationCap, Store, Wifi } from "lucide-react"
    ...
    const loadData = async () => {
      try {
        ...
        const categories: DataCategory[] = [
          {
            title: "Provinces",
            description: "All South African provinces with detailed information",
            icon: MapPin,
        ...
        setTotalRecords(categories.reduce((sum, category) => sum + category.count, 0))
        setLoading(false)
      } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">ZA Public Data</h1>
                <p className="text-sm text-gray-600">South African Public Dataset Explorer</p>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Comprehensive South African Public Data</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Access structured, up-to-date information about provinces, municipalities, banks, educational institutions,
            and more. Perfect for developers, researchers, and data analysts.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-xl border p-8">
          <h3 className="text-2xl font-bold mb-6 text-center">Dataset Overview</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {dataCategories.find((c) => c.title === "Provinces")?.count || 0}
              </div>
              <div className="text-sm text-gray-600">Provinces</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {dataCategories.find((c) => c.title === "Municipalities")?.count || 0}
              </div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {dataCategories.find((c) => c.title === "Universities")?.count || 0}
              </div>
